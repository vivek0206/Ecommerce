...
public class tempActivity extends AppCompatActivity {
    ...
    private EditText categoryName,productName,originalPrice,offPrice,productQuantity;
    private Button submit;
    private FirebaseUser user;
    private DatabaseReference databaseReference;
    private StorageReference storageReference;
    private static final int PICK_IMAGE_REQUEST = 2;
    private String Cname,Pname,originalP,offP,productQ;
    ...
    private void uploadProduct()
    {
        ...
        if(Cname.isEmpty()|| Pname.isEmpty()|| originalP.isEmpty()|| offP.isEmpty()|| productQ.isEmpty())
        {
                            ...
                            reference.getDownloadUrl()
                                    .addOnSuccessListener(new OnSuccessListener<Uri>() {
                                        ...
                                        public void onSuccess(Uri uri) {
                                            Product model = new Product(uri.toString(),Cname,Pname,originalP,offP,productQ,"0");
