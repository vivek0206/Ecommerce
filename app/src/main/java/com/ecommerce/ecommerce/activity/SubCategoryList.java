...
//                Toast.makeText(getApplicationContext(),query,Toast.LENGTH_SHORT).show();
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                searchList.clear();
                Query firebaseQuery = database.getReference().child(getResources().getString(R.string.Search)).orderByKey().startAt(newText.toLowerCase().trim()).endAt(newText.toLowerCase().trim()+"\uf8ff").limitToFirst(20);
