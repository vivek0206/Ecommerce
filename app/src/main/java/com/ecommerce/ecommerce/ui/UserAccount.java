...
public class UserAccount extends Fragment {
    ...
    private TextView userName,userPhone,userPoints;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(MainActivity.staticUserPointModel!=null)
        {
            userPoints.setText("Points: "+MainActivity.staticUserPointModel.getPoints());
        }
    ...
    private void init(View view) {
        ...
        userPoints = view.findViewById(R.id.account_userPoints);
